...
**Purpose**
Practice working with graphs, practice implementing a more complex game. Internally, an adjacency matrix is used for the game board, which is very space inefficient for a simple 2d grid. Pathfinding is done using BFS.
